...
from pioformer.model.utils import DistanceDropEdge
...
class LocalEncoder(nn.Module):
    ...
    def forward(self, data: TemporalData) -> torch.Tensor:
        for t in range(self.historical_steps):
            ...
            # edge_index_t : The index pair of the edge matrix at frame t
            data[f'edge_attr_{t}'] = \
                data['positions'][data[f'edge_index_{t}'][0], t] - data['positions'][data[f'edge_index_{t}'][1], t]
            # edge_attr_t : The rel_distance in the edge matrix at frame t
        if self.parallel:
